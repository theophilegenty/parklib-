...
class Scannerpage2Widget extends StatefulWidget {
  const Scannerpage2Widget({Key? key}) : super(key: key);

  @override
  _Scannerpage2WidgetState createState() => _Scannerpage2WidgetState();
}

class _Scannerpage2WidgetState extends State<Scannerpage2Widget> {
    ...
    return StreamBuilder<List<ReservationdeplaceRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ReservationdeplaceRecord>
            scannerpage2ReservationdeplaceRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final scannerpage2ReservationdeplaceRecord =
            scannerpage2ReservationdeplaceRecordList.isNotEmpty
                ? scannerpage2ReservationdeplaceRecordList.first
                : null;
        return Scaffold(
          key: scaffoldKey,
                        ...
                        Container(
                          ...
                          child: FlutterFlowTimer(
                            ...
                            onEnded: () async {
                              ...
                              await scannerpage2ReservationdeplaceRecord!
                                  .reference
