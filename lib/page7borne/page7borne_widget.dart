...
class Page7borneWidget extends StatefulWidget {
  const Page7borneWidget({Key? key}) : super(key: key);

  @override
  _Page7borneWidgetState createState() => _Page7borneWidgetState();
}

class _Page7borneWidgetState extends State<Page7borneWidget> {
                        ...
                        builder: (context, snapshot) {
                          ...
                          return Row(
                            ...
                            children: [
                              ...
                              Padding(
                                padding:
                                    EdgeInsetsDirectional.fromSTEB(30, 4, 0, 0),
                                child: Container(
                                  width: 50,
                                  height: 35,
                                  decoration: BoxDecoration(
                                  ...
                                  child: ToggleIcon(
                                    onPressed: () async {
                                      final usersUpdateData = {
                                        'Borne7favourite':
                                            !rowUsersRecord!.borne7favourite!,
                                      };
                                      await rowUsersRecord!.reference
                                          .update(usersUpdateData);
                                    },
                                    value: rowUsersRecord!.borne7favourite!,
                                    onIcon: Icon(
                                      Icons.favorite,
                                      color: FlutterFlowTheme.of(context)
                                          .primaryText,
