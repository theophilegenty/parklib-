...
class Scannerpage5Widget extends StatefulWidget {
  const Scannerpage5Widget({Key? key}) : super(key: key);

  @override
  _Scannerpage5WidgetState createState() => _Scannerpage5WidgetState();
}

class _Scannerpage5WidgetState extends State<Scannerpage5Widget> {
    ...
    return StreamBuilder<List<ReservationdeplaceRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ReservationdeplaceRecord>
            scannerpage5ReservationdeplaceRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final scannerpage5ReservationdeplaceRecord =
            scannerpage5ReservationdeplaceRecordList.isNotEmpty
                ? scannerpage5ReservationdeplaceRecordList.first
                : null;
        return Scaffold(
          key: scaffoldKey,
                        ...
                        Container(
                          ...
                          child: FlutterFlowTimer(
                            ...
                            onEnded: () async {
                              ...
                              await scannerpage5ReservationdeplaceRecord!
                                  .reference
