...
class Scannerpage3Widget extends StatefulWidget {
  const Scannerpage3Widget({Key? key}) : super(key: key);

  @override
  _Scannerpage3WidgetState createState() => _Scannerpage3WidgetState();
}

class _Scannerpage3WidgetState extends State<Scannerpage3Widget> {
    ...
    return StreamBuilder<List<ReservationdeplaceRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ReservationdeplaceRecord>
            scannerpage3ReservationdeplaceRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final scannerpage3ReservationdeplaceRecord =
            scannerpage3ReservationdeplaceRecordList.isNotEmpty
                ? scannerpage3ReservationdeplaceRecordList.first
                : null;
        return Scaffold(
          key: scaffoldKey,
                        ...
                        Container(
                          ...
                          child: FlutterFlowTimer(
                            ...
                            onEnded: () async {
                              ...
                              await scannerpage3ReservationdeplaceRecord!
                                  .reference
