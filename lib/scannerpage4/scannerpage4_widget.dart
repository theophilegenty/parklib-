...
class Scannerpage4Widget extends StatefulWidget {
  const Scannerpage4Widget({Key? key}) : super(key: key);

  @override
  _Scannerpage4WidgetState createState() => _Scannerpage4WidgetState();
}

class _Scannerpage4WidgetState extends State<Scannerpage4Widget> {
    ...
    return StreamBuilder<List<ReservationdeplaceRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ReservationdeplaceRecord>
            scannerpage4ReservationdeplaceRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final scannerpage4ReservationdeplaceRecord =
            scannerpage4ReservationdeplaceRecordList.isNotEmpty
                ? scannerpage4ReservationdeplaceRecordList.first
                : null;
        return Scaffold(
          key: scaffoldKey,
                        ...
                        Container(
                          ...
                          child: FlutterFlowTimer(
                            ...
                            onEnded: () async {
                              ...
                              await scannerpage4ReservationdeplaceRecord!
                                  .reference
