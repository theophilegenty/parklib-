...
class Borne6Widget extends StatefulWidget {
  const Borne6Widget({
    Key? key,
    this.borneforetnoire,
  }) : super(key: key);

  final MarkerRecord? borneforetnoire;

  @override
  _Borne6WidgetState createState() => _Borne6WidgetState();
}

class _Borne6WidgetState extends State<Borne6Widget> {
  @override
  void initState() {
    super.initState();
