...
class Page2borneWidget extends StatefulWidget {
  const Page2borneWidget({Key? key}) : super(key: key);

  @override
  _Page2borneWidgetState createState() => _Page2borneWidgetState();
}

class _Page2borneWidgetState extends State<Page2borneWidget> {
                    ...
                    builder: (context, snapshot) {
                      ...
                      return Row(
                        ...
                        children: [
                          ...
                          Padding(
                            padding:
                                EdgeInsetsDirectional.fromSTEB(30, 13, 0, 0),
                            child: Text(
                              'Place de Bordeaux',
                              ...
                              child: ToggleIcon(
                                onPressed: () async {
                                  final usersUpdateData = {
                                    'Borne2favourite':
                                        !rowUsersRecord!.borne2favourite!,
                                  };
                                  await rowUsersRecord!.reference
                                      .update(usersUpdateData);
                                },
                                value: rowUsersRecord!.borne2favourite!,
                                onIcon: Icon(
                                  Icons.favorite,
                                  color:
                                      FlutterFlowTheme.of(context).primaryText,
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(
                            columnReservationdeplaceRecord!.nombredeplaceborne2!
                                .toString(),
                            style: FlutterFlowTheme.of(context).bodyText1,
                          ),
                        ),
