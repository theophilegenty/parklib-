...
class Scannerpage7Widget extends StatefulWidget {
  const Scannerpage7Widget({Key? key}) : super(key: key);

  @override
  _Scannerpage7WidgetState createState() => _Scannerpage7WidgetState();
}

class _Scannerpage7WidgetState extends State<Scannerpage7Widget> {
    ...
    return StreamBuilder<List<ReservationdeplaceRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ReservationdeplaceRecord>
            scannerpage7ReservationdeplaceRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final scannerpage7ReservationdeplaceRecord =
            scannerpage7ReservationdeplaceRecordList.isNotEmpty
                ? scannerpage7ReservationdeplaceRecordList.first
                : null;
        return Scaffold(
          key: scaffoldKey,
                        ...
                        Container(
                          ...
                          child: FlutterFlowTimer(
                            ...
                            onEnded: () async {
                              ...
                              await scannerpage7ReservationdeplaceRecord!
                                  .reference
